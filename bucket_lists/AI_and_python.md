...
## 3D + Shape Analysis + AR
-  Python Blender (170 pages)
-  C++ PCL point cloud lib  https://pointclouds.org/ 
-  PCL https://pcl.readthedocs.io/projects/tutorials/en/master/ 
...
## FFI / HPC 
-  Python ipyparallel https://ipyparallel.readthedocs.io/en/latest/
...
## Python metaprogramming, internals, FFI
...
-  mcpyrate https://github.com/Technologicat/mcpyrate/blob/master/doc/main.md macro expander
-  Python pyformlang https://pyformlang.readthedocs.io/en/latest/  manipulate formal languages and automata
-  RPython https://rpython.readthedocs.io/en/latest/index.html dynamic language framework
...
-  Python Gensim https://radimrehurek.com/gensim/auto_examples/index.html#documentation 
-  DkPro https://dkpro.github.io/ classic NLPlibs
-  Grammer Rules (540 words)
-  Alen NLP (50 pages)


## SFT
-  HuggingFace Docs, blogs
-  HuggingFace BitsAndBytes https://huggingface.co/docs/bitsandbytes/ 
-  HuggingFace SafeTensors
-  Microsoft DeepSpeed (130 pages) https://www.deepspeed.ai/tutorials/  
...
-  Tunix: A JAX-Native Library for LLM Post-Training https://developers.googleblog.com/en/introducing-tunix-a-jax-native-library-for-llm-post-training/
...
-  Inverse RL reward learning https://imitation.readthedocs.io/en/latest/index.html 
-  https://spinningup.openai.com/en/latest/ OpenAI Spinning Up RL (90 pages)


## Theory - Deep learning 
-  Papers Explained Blog - Ritvik (360 pages) https://ritvik19.medium.com/ - **10%**
-  https://oricohen.gitbook.io/machine-and-deep-learning-compendium 
...
-  https://www.louisbouchard.ai/ blog
...
-  online ebook: The Geometry of Mathematical Methods https://books.physics.oregonstate.edu/GMM/book.html good resource !
...
-  Book: Mathematics for Computer Science https://courses.csail.mit.edu/6.042/spring18/mcs.pdf
...
- Maths: the Stacks Project https://stacks.math.columbia.edu/browse Algebraic Geometry
...
## papers explained 
-  Pytorch paper implementations annotated https://nn.labml.ai/ 
...
## time series, causality, metaheuristics
...
-  Python MinGrammer https://diagrams.mingrammer.com/docs/getting-started/installation - systems design diagrams
...
## PyTorch
 - LightningAI PyTorch Infra https://lightning.ai/docs/overview/ 
  - AI Studio
  - Lightning: SFT
  - LitServe: inference serving
  - LitAI: router + agents
  - LitGPT: pretrained models
  - Fabric: GPU scale
  - LitData: data pipelines
...
-  Tensorflow.IO
-  Tensorly http://tensorly.org/stable/index.html  - like EinOps ? 
-  
## Python - core libs
