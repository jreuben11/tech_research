...
-  Google Highway https://google.github.io/highway/en/master/  C++ portable SIMD/vector intrinsics
...
-  mfem + GLVis finite element discretization https://mfem.org/ https://glvis.org/
...
-  gn https://gn.googlesource.com/gn/ meta-build system that generates build files for Ninja
...
-  Gnome Dev Docs https://developer.gnome.org/documentation/
...
-  Clutter Cookbook (DEAD) https://developer.gnome.org/clutter-cookbook/1.23/ 
-  C Gobject (25 pages)
-  C++ Glib (400 pages)
...
## ebpf
- Book: ebpf (liz rice) (170 pages)
- -  Linux Bpfman https://bpfman.io/main/ 
-  https://github.com/iovisor/bcc BPF BCC

## Ubuntu
-  Ubuntu wiki https://help.ubuntu.com/community/UnityLaunchersAndDesktopFiles
...
-  Determinate https://docs.determinate.systems/ toolchain
...
-  C++ CGAL (780 pages)
-  VTK https://kitware.github.io/vtk-examples/site/VTKBook/00Preface/ 
...
-  C++ Hilo (220 pages) - DEAD (PPL/ConcRT/C++CX)
-  C++ SAL https://learn.microsoft.com/en-us/cpp/code-quality/understanding-sal?view=msvc-170
- -  Casablanca (35 pages) REST - DEAD
- C++/CX http://msdn.microsoft.com/en-us/library/hh699871(v=vs.110).aspx 
-  COM http://msdn.microsoft.com/library/ms680573(VS.85).aspx 
...
-  Linux from scratch (185 pages) -  http://www.linuxfromscratch.org/ 
...
-  Wayland (140 pages)  https://wayland-book.com/ 
...
-  C StdLib (600 pages)
-  CAF: C++ Actor Framework https://actor-framework.readthedocs.io/en/stable/ https://github.com/actor-framework/actor-framework
  C++ Concurrency
-  C++ Auto-vectorization cookbook
-  C++ 64bit (80 pages)
-  C Networking (240 pages)
-  C Libcello http://libcello.org/ Higher level programming in C
-  http://www.viva64.com/en/d/ C++ static analysis
-  C++ libs http://www.efytimes.com/e1/fullnews.asp?edid=146799 
-  Intel OneAPI TBB https://www.intel.com/content/www/us/en/developer/tools/oneapi/onetbb.html
...
- C++ BehaviourTree.cpp https://www.behaviortree.dev/docs/intro 
-  Compiler Options Hardening Guide for C and C++ https://best.openssf.org/Compiler-Hardening-Guides/Compiler-Options-Hardening-Guide-for-C-and-C++.html 
-  C++ OpenAL audio https://www.openal.org/documentation/
...
-  Playlist: LazyVim - @ElijahManor https://www.youtube.com/playlist?list=PLXJ0on0Dau77THnZeQLqK1hV6s2udsaAm 
-  Book: Vim book
...
-  Termux https://www.youtube.com/playlist?list=PLcyWKrxmiUYMW2P5y9A9yKZY7jHBbQfgr 
-  -  Android Internals https://source.android.com/docs/core 

  
## Bash Foo
-  Book: Command Line Kung Fu (100 pages)
-  Book: Linux insides / Linux zines
-  Bash pitfalls
-  Cyberciti Nixcraft
...
-  -  Visidata CLI – bash data engineering ! https://jsvine.github.io/intro-to-visidata/ https://www.visidata.org/docs/ 
...
-  WireGuard (15 pages)
-  OpenLDAP (110 pages)
- Posting https://posting.sh/guide/ - Curl TUI
-  IPV6 essentials (220 pages)
-  IPTables Pocket Guide

## assembly
- FFMpeg assembly lessons https://github.com/FFmpeg/asm-lessons
...
-  WARP https://www.youtube.com/@warpdotdev/playlists 
...
-  Vuforia AR Engine https://developer.vuforia.com/ (DEAD)
-  Google OpenThread https://github.com/openthread/openthread networking comms
-  Intel SILK C++ extensions https://www.cilkplus.org/ (DEAD)
